...
从 [Releases 页面](https://github.com/lovesmile/hermes-desktop-ui/releases) 下载 `HermesDesktop-Setup-v1.0.4.exe`，
...
`desktop_db.json` 由客户端自行管理，与 Hermes 服务端无关。支持双隔离层：

- **连接模式隔离**：local/embedded/remote 各用独立 DB 文件（`desktop_db.json`, `desktop_db_embedded.json`, `desktop_db_<ip>.json`）
...
```json
{
  ...
  "display_sessions": {
    "1747612530123456": {
      ...
      "title": "05/23 帮我写个爬虫",
      "remark": "重要项目",
      "current_backend_id": "api-7a098235ae77c596",
      "backend_id_history": ["api-6e2f193c79997b6e", "api-7a098235ae77c596"],
      "preview": "最后一条消息的预览",
  ...
  "sessions": {
    "api-7a098235ae77c596": {
      "id": "api-7a098235ae77c596",
      "title": "05/23 帮我写个爬虫",
      "source": "cli",
      "created_at": "2026-05-23T19:15:30.000Z",
      "updated_at": "2026-05-23T19:16:45.000Z",
...
- **自动迁移**：v1.0.3 及以前的老数据首次启动自动迁移至 `display_sessions` 层
...
4. Inno Setup 编译安装包 `HermesDesktop-Setup-v1.0.4.exe`
